...
public class TestServlet {
	...
	public Response runTest(@PathParam("workspace") String workspaceUUID, @PathParam("uuid") String testUUID)
		...
		if (configuration.getDecisionService() == null) {
			...
			executionResult = workspace.getDecisionSession().getDMNDecisionSession().executeModel(mainModelNamespace,
					configuration.getDecisionService().getName(), input.getValue());
		}
