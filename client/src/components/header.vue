<template>
	<nav class="navbar navbar-expand mb-4">
		...
		<ul class="navbar-nav mr-auto">
			<li class="nav-item dropdown" v-for="route of routes" v-if="$route.params.workspace !== undefined" v-on:mouseenter="route.visible = true" v-on:mouseleave="route.visible = false">
		...
		<router-link exact-active-class="active" class="nav-link" v-if="$route.params.workspace !== undefined" v-bind:to="'/' + $route.params.workspace + '/settings'">
