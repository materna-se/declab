	...
	<div>
		...
		<div class="d-flex">
			<div class="btn-group mr-2">
				<button type="button" class="btn" v-bind:class="[value.access === 'PUBLIC' ? 'btn-secondary' : 'btn-outline-secondary']" v-on:click="value.access = 'PUBLIC'">
				...
				<button type="button" class="btn" v-bind:class="[value.access === 'PROTECTED' ? 'btn-secondary' : 'btn-outline-secondary']" v-on:click="value.access = 'PROTECTED'">
					<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="d-block">
				...
				<button type="button" class="btn" v-bind:class="[value.access === 'PRIVATE' ? 'btn-secondary' : 'btn-outline-secondary']" v-on:click="value.access = 'PRIVATE'">
					<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="d-block">
