	...
	<div>
		...
		<div class="d-flex">
			<div class="btn-group mr-2" role="group" aria-label="Enter protection...">
				...
				<button type="button" class="btn" aria-label="Protected: Anonymous users can read, authenticated users can also create, update and delete entities inside this workspace." v-bind:class="[value.access === 'PROTECTED' ? 'btn-secondary' : 'btn-outline-secondary']" v-on:click="value.access = 'PROTECTED'" v-tooltip="{content: '<b>Protected:</b> Anonymous users can read, authenticated users can also create, update and delete entities inside this workspace.'}">
					<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="d-block">
