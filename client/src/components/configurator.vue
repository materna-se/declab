	...
	<div>
		...
		<div class="d-flex">
			<div class="btn-group mr-2">
				<button type="button" class="btn" v-bind:class="[value.access === 'PUBLIC' ? 'btn-secondary' : 'btn-outline-secondary']" v-on:click="value.access = 'PUBLIC'" v-tooltip="{content: '<b>Public:</b> Anonymous users can create, read, update and delete entities inside this workspace.'}">
				...
				<button type="button" class="btn" v-bind:class="[value.access === 'PROTECTED' ? 'btn-secondary' : 'btn-outline-secondary']" v-on:click="value.access = 'PROTECTED'" v-tooltip="{content: '<b>Protected:</b> Anonymous users can read, authenticated users can also create, update and delete entities inside this workspace.'}">
					<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="d-block">
				...
				<button type="button" class="btn" v-bind:class="[value.access === 'PRIVATE' ? 'btn-secondary' : 'btn-outline-secondary']" v-on:click="value.access = 'PRIVATE'" v-tooltip="{content: '<b>Private: </b> Anonymous users can\'t enter the workspace, authenticated users can create, read, update and delete entities inside this workspace.'}">
					<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="d-block">
