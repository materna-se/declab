<template>
	<ul class="list-group">
		<li class="list-group-item" v-for="entry of entries">
			<h5 class="mb-3" style="display: flex; align-items: center"><small><span class="badge bg-primary" style="line-height: inherit;font-size: 0.85rem;">{{entry.accessType}}</span>&ensp;</small>{{entry.name}}</h5>
