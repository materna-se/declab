<template>
	<div>
		...
		<div v-else-if="value.collection">
			<p class="mb-3 text-center text-muted" v-if="value.value.length === 0">Please select a type!</p>
		...
		<div v-else>
			<p class="mb-3 text-center text-muted" v-if="Object.keys(value.value).length === 0">Please select a type!</p>
			<table class="table table-bordered mb-0">
				<tbody>
