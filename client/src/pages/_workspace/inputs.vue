	...
	<div>
		...
		<div class="row">
			<div class="col-3 mb-4">
				<div class="row mb-2">
					<div class="col-12">
						<button class="btn btn-block btn-outline-secondary mb-2" @click="order = !order; getInputs()">
							<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="d-block mx-auto">
				...
				<div class="list-group">
					<template v-if="Object.keys(inputs).length !== 0">
						<div class="list-group-item list-group-item-action c-pointer" v-for="(input, uuid) in inputs" :key="uuid" @click.self="setViewMode(uuid)">
							<span class="d-block float-left me-4" @click="setViewMode(uuid)">{{input.name}}</span>
							<div class="float-right">
								...
								<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="d-block float-left" @click="deleteInput(uuid)">
			...
			<div class="col-9 mb-4">
				...
				<div class="card" v-if="mode === 'ADD' || mode === 'EDIT'">
					<div class="card-body">
						...
						<button class="btn btn-block btn-outline-secondary" v-if="mode === 'ADD'" @click="addInput">Save Input</button>
						<button class="btn btn-block btn-outline-secondary" v-if="mode === 'EDIT'" @click="editInput">Save Input</button>
					</div>
				</div>
			</div>
		</div>
