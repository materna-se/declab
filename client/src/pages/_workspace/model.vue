			...
			<div class="mb-2 draggable" @drop="onReplaceModelDrop($event, index)" @dragover="onModelDragOver" @dragenter="onModelDragOver" v-for="(importedModel, index) of importedModels" :key="importedModel.namespace">
				<div class="card">
					<div class="card-header d-flex align-items-center">
						...
						<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" @click="editModel(importedModel.namespace)" class="c-pointer me-2">
...
<script>
	...
	export default {
		...
		methods: {
			...
			editModel(namespace) {
				window.open(this.$router.resolve('/' + this.$route.params.workspace + '/editor/' + base64.encode(namespace)).href, '_blank', 'noopener');
			},
			downloadModel(index) {
