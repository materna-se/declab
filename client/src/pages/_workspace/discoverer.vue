	...
	<div>
		...
		<div class="row">
			...
			<div class="col-8 mb-4" v-if="input !== null">
				<h4 class="mb-2">Input</h4>
				<json-builder class="mb-4" v-bind:template="options.input" v-bind:fixed="true" v-bind:fixed-root="true" v-bind:fixed-values="true" v-bind:convert="true" v-on:update:path="options.inputSelector = convertPath($event); startDebouncedDiscovery()"/>
