	...
	<div>
		...
		<div class="row">
			<div class="col-4 mb-4">
				...
				<button class="btn btn-block btn-outline-secondary mb-4" v-on:click="addInput()">
				...
				<button class="btn btn-block btn-outline-secondary mb-4" :disabled="inputTemplateSelected === null" v-else v-on:click="stopDiscovery()">
				...
				<div class="card" v-if="results.subtree.length > 0">
					<div class="card-body">
						...
						<div class="row mx-0 mb-2 flex-row"  v-if="isDiscoveryInValidState()">
							<button class="btn btn-block btn-outline-secondary mr-4 mb-4" style="flex: 1" v-on:click="refreshDiscoveryTable()">
								Refresh
								<svg style="width:24px;height:24px" viewBox="0 0 24 24">
							...
							<button class="btn btn-outline-secondary ml-4 mb-4" v-on:click="toggleForceCleanTableCells(); refreshDiscoveryTable()" title="If table output cells contain a single key-value pair, this button toggles whether or not the output text is displayed in the cells.">
