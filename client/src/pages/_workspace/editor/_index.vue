	...
	<div>
		<div class="d-flex align-items-center mb-2">
			...
			<div class="ms-auto c-pointer" style="display: flex; align-items: center">
				...
				<span class="ms-auto me-2" style="line-height: 1;" v-if="benchmarkResults.length > 0">Cold: {{this.benchmarkResults[this.benchmarkResults.length - 1]["cold"]}}</span>
				<span class="ms-auto me-2" style="line-height: 1;" v-if="benchmarkResults.length > 0">Average: {{this.benchmarkResults[this.benchmarkResults.length - 1]["average"]}}</span>
	...
	export default {
		...
		methods: {
			...
			async benchmarkModel() {
				const result = await Network.benchmarkModel(this.inputTemplateSelected);

				this.benchmarkModel.push(result);
			}
		}
	}
</script>
