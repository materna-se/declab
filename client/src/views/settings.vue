		...
		<div class="col-6">
			<div class="card mb-4">
				...
				<div class="card-body">
					...
					<p><b>Public.</b> Anonymous users can create, read, update and delete entities inside this workspace.</p>
					<p><b>Protected.</b> Anonymous users can read, authenticated users can also create, update and delete entities inside this workspace.</p>
					<p><b>Private.</b> Anonymous users can't enter the workspace, authenticated users can create, read, update and delete entities inside this workspace.</p>
				</div>
			</div>
		</div>
		<div class="col-6">
