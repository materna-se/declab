		...
		<div class="col-6">
			<div class="card mb-4">
				...
				<div class="card-body">
					...
					<input class="form-control mb-2" v-model="workspace.name">

					<h5 class="mb-2">Description</h5>
					<input class="form-control mb-2" v-model="workspace.description">
					...
					<div class="d-flex mb-2">
						<div class="btn-group mr-2">
							<button type="button" class="btn" v-bind:class="[workspace.access === 'PUBLIC' ? 'btn-secondary' : 'btn-outline-secondary']" v-on:click="workspace.access = 'PUBLIC'">
							...
							<button type="button" class="btn" v-bind:class="[workspace.access === 'PROTECTED' ? 'btn-secondary' : 'btn-outline-secondary']" v-on:click="workspace.access = 'PROTECTED'">
								<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="d-block">
							...
							<button type="button" class="btn" v-bind:class="[workspace.access === 'PRIVATE' ? 'btn-secondary' : 'btn-outline-secondary']" v-on:click="workspace.access = 'PRIVATE'">
								<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" class="d-block">
						...
						<input type="password" placeholder="Enter Password..." class="form-control flex-fill" v-model="workspace.token">
					</div>
		...
		<div class="col-12">
			<div class="list-group mb-4">
				<div class="list-group-item" v-for="entry of log">
					<p class="mb-0"><b>{{entry.timestamp}}</b></p>
